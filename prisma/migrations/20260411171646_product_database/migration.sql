...
INSERT INTO "new_Ingredient" ("bottleCostCents", "bottleSizeMl", "casePackSize", "createdAt", "id", "ingredientCategory", "isActive", "name", "organizationId", "purchaseCostCents", "purchaseQty", "purchaseUnit", "type", "updatedAt", "vendor", "vendorId") SELECT "bottleCostCents", "bottleSizeMl", "casePackSize", "createdAt", "id", "ingredientCategory", "isActive", "name", "organizationId", "purchaseCostCents", "purchaseQty", "purchaseUnit", "type", "updatedAt", "vendor", "vendorId" FROM "Ingredient";
