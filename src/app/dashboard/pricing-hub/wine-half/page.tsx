  ...
  return (
    <div className="max-w-full">
      <div className="mb-4 flex items-start justify-between flex-wrap gap-2">
        <div>
          <h2 className="text-lg font-semibold text-[var(--brand-brown)]">Wine Half Bottle (375ml)</h2>
          <p className="text-sm text-[var(--ink-muted)] mt-0.5">
            Only items whose category is <code className="text-xs px-1 rounded bg-[var(--brand-cream)]">Wine - Half Bottle - *</code>.
