...
export default async function NewDatabaseProductPage() {
  const orgId = await getOrganizationId();

  const [vendors, locations, existingProducts, settings, units] =
    await Promise.all([
  ...
  return (
    <div className="p-4 lg:p-8 max-w-2xl">
      <h1 className="text-2xl font-bold mb-6">Add Product to Database</h1>
      <ProductFormV2
        vendors={vendors}
        locations={locations}
